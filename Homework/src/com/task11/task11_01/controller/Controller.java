package com.task11.task11_01.controller;

import com.task11.task11_01.controller.command.Command;
import com.task11.task11_01.controller.command.ItemMenu;
import com.task11.task11_01.exception.UnExistItemMenu;
...
public class Controller {
    ...
    public void run() {
        ...
        if (result != null) {
            ...
            ItemMenu.EXIT.getCommand().execute(service);
        }
